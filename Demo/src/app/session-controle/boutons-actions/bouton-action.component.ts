...
@Component({
    ...
    template: `
            ...
            <a class="bouton bouton-rouge petit" href="javascript:;" (click)="onSuppressionClick()" title="supprimer" *ngIf="etat!='C'"><i class="fa fa-remove" style="font-size:15px;color:white"></i></a>    
    `
})

export class ButtonSessionActionComponent implements ViewCell, OnInit {
    private etat: string;
    ...
    onClotureClick() {
        this.msgConfirmation = "Souhaitez-vous clôturer cette session ? Dans l'affirmative, vous ne pourrez plus ajouter ou supprimer des cartes mais la consultation restera néanmoins possible."
